def is_valid_assignment(assignment, task, time_slot, subsystems, power_needs, power_limits):
    ...
    for task in tasks:
        if task not in assignment:
            ...
            for time_slot in range(1, 6):
                if is_valid_assignment(assignment, task, time_slot, subsystems, power_needs, power_limits):
